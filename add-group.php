...
mysql_query ("insert into groups(gname) values ('$gname')");
...
<div class="wrapper"> 
    ...
    <?php include "admin-top-menu.php" ?>
        ...
        <div class="content">
			...
			<tr><td  align='center' height='25px' style='text-decoration:none; color:#009900; font-size:14px'> Group Added successfully.</td></tr>
			</table><br/>";
			}

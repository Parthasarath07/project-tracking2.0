...
mysql_query ("insert into category(categoryName) values ('$categoryName')");
...
<div class="wrapper"> 
    ...
    <?php include "admin-top-menu.php" ?>
        ...
        <div class="content">
			...
			<tr><td  align='center' height='25px' style='text-decoration:none; color:#009900; font-size:14px'> Category Added successfully.</td></tr>
			</table><br/>";
			}
